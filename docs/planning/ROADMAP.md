...
```mermaid
flowchart TD
    Phase8["Phase 8: 音频源与听书进阶 (v1.4.0)"] --> P8_1["Legado 3.0 在线音频书源协议 (边下边播)"]
    Phase8 --> P8_2["Edge-TTS 微软小晓云端超拟人神经语音接入"]
    Phase8 --> P8_3["书籍正文导出与打印排版 (精排 TXT / PDF 视图)"]
    
    Phase9["Phase 9: 生态融合与跨端备份 (v2.0.0)"] --> P9_1["局域网移动端扫码即阅与 WebDAV 自动增量合并"]
    Phase9 --> P9_2["AI 智能辅助阅读 (上下文摘要 / 角色关系图谱生成)"]
```
